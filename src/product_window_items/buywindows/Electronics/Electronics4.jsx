      ...
      <div className="w-[600px] h-[600px]">
        <div className="border border-black rounded-xl flex flex-row items-center justify-center">
          <div>
            ...
            <img
              src="https://rukminim2.flixcart.com/image/312/312/xif0q/microwave-new/9/j/r/-original-imah2hyhhzdqjj4r.jpeg?q=70"
              alt="checkoutitem"
          ...
          <div>
            ...
            SAMSUNG 28 L Curd Making
            </p>
            <p className="font-semibold text-lg">₹12,590</p>
