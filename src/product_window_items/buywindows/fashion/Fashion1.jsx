      ...
      <div className="w-[600px] h-[600px]">
        <div className="border border-black rounded-xl flex flex-row items-center justify-center">
          <div>
            ...
            <img
              src="https://i.ebayimg.com/thumbs/images/g/Su8AAOSwm61kVfiu/s-l1200.webp"
              alt="checkoutitem"
          ...
          <div>
            ...
            Filled Drop Earrings Women Gifts Anniversary Jewelry
            </p>
            <p className="font-semibold text-lg">₹450   </p>
