      ...
      <div className="w-[600px] h-[600px]">
        <div className="border border-black rounded-xl flex flex-row items-center justify-center">
          <div>
            ...
            <img
              src="https://rukminim2.flixcart.com/image/312/312/xif0q/mobile/g/x/h/-original-imagtc3k6zztrhnb.jpeg?q=70"
              alt="checkoutitem"
          ...
          <div>
            ...
            <p className="font-semibold text-lg">₹1,39,990</p>
...
export default Iphone15promaxblack