      ...
      <div className="w-[600px] h-[600px]">
        <div className="border border-black rounded-xl flex flex-row items-center justify-center">
          <div>
            ...
            <img
              src="https://rukminim2.flixcart.com/image/312/312/xif0q/mobile/i/s/b/-original-imagrdefh2xgenzz.jpeg?q=70"
              alt="checkoutitem"
          ...
          <div>
            <p className="font-mono text-lg ">
             Nothing Phone (2) (White, 256 GB)
            </p>
            <p className="font-semibold text-lg">₹38,999</p>
...
export default Nothingphone2white